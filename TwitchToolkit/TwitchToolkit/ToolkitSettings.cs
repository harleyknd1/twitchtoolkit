...
public class ToolkitSettings : ModSettings
{
	...
	{
		Rect viewRect = new Rect(0f, 0f, mainRect.width - 16f, 2800f);
		Listing_Standard options = new Listing_Standard();
		...
		options.SliderLabeled("TwitchToolkitCoinInterval".Translate(),  ref CoinInterval, Math.Round((float)CoinInterval).ToString(), 1f, 15f);
		options.SliderLabeled("TwitchToolkitCoinAmount".Translate(),  ref CoinAmount, Math.Round((float)CoinAmount).ToString());
		options.AddLabeledNumericalTextField("TwitchToolkitMinimumPurchasePrice".Translate(),  ref MinimumPurchasePrice, 0.8f);
		options.Gap(12f);
		options.CheckboxLabeled("TwitchToolkitUnlimitedCoins".Translate(), ref UnlimitedCoins, null);
		options.GapLine(12f);
		options.Gap(12f);
		options.CheckboxLabeled("TwitchToolkitChatReqsForCoins".Translate(), ref ChatReqsForCoins, null);
		options.SliderLabeled("TwitchToolkitTimeBeforeHalfCoins".Translate(),  ref TimeBeforeHalfCoins, Math.Round((double)TimeBeforeHalfCoins).ToString(), 15f, 120f);
		options.SliderLabeled("TwitchToolkitTimeBeforeNoCoins".Translate(),  ref TimeBeforeNoCoins, Math.Round((double)TimeBeforeNoCoins).ToString(), 30f, 240f);
		options.GapLine(12f);
		options.Gap(12f);
		Text.Font =((GameFont)2);
		...
		options.Gap(12f);
		options.CheckboxLabeled("TwitchToolkitMaxEventsLimit".Translate(), ref MaxEvents, null);
		options.Gap(12f);
		options.AddLabeledNumericalTextField("TwitchToolkitMaxBadEvents".Translate(), ref MaxBadEventsPerInterval, 0.8f);
		options.AddLabeledNumericalTextField("TwitchToolkitMaxGoodEvents".Translate(), ref MaxGoodEventsPerInterval, 0.8f);
		options.AddLabeledNumericalTextField("TwitchToolkitMaxNeutralEvents".Translate(), ref MaxNeutralEventsPerInterval, 0.8f);
		options.AddLabeledNumericalTextField("TwitchToolkitMaxItemEvents".Translate(), ref MaxCarePackagesPerInterval, 0.8f);
		options.Gap(12f);
		options.CheckboxLabeled("TwitchToolkitEventsHaveCooldowns".Translate(), ref EventsHaveCooldowns, null);
		options.GapLine(12f);
		options.Gap(12f);
		Text.Font =((GameFont)2);
		...
		options.SliderLabeled("TwitchToolkitKarmaCap".Translate(),  ref KarmaCap, Math.Round((double)KarmaCap).ToString(), 150f, 600f);
		options.CheckboxLabeled("TwitchToolkitBanViewersWhoAreBad".Translate(), ref BanViewersWhoPurchaseAlwaysBad, null);
		options.Gap(12f);
		...
		options.Gap(12f);
		options.CheckboxLabeled("TwitchToolkitKarmaReqsForGifting".Translate(), ref KarmaReqsForGifting, null);
		options.Gap(12f);
		options.SliderLabeled("TwitchToolkitMinKarmaForGifts".Translate(), ref MinimumKarmaToRecieveGifts, Math.Round((double)MinimumKarmaToRecieveGifts).ToString(), 10f);
		options.SliderLabeled("TwitchToolkitMinKarmaSendGifts".Translate(), ref MinimumKarmaToSendGifts, Math.Round((double)MinimumKarmaToSendGifts).ToString(), 20f, 150f);
		options.Gap(12f);
		options.GapLine(12f);
		options.Label("TwitchToolkitGoodViewers".Translate(), -1f, null);
		options.SliderLabeled("TwitchToolkitGoodKarma".Translate(),  ref TierOneGoodBonus, Math.Round((double)TierOneGoodBonus).ToString(), 1f);
		options.SliderLabeled("TwitchToolkitNeutralKarma".Translate(),  ref TierOneNeutralBonus, Math.Round((double)TierOneNeutralBonus).ToString(), 1f);
		options.SliderLabeled("TwitchToolkitBadKarma".Translate(),  ref TierOneBadBonus, Math.Round((double)TierOneBadBonus).ToString(), 1f);
		options.Gap(12f);
		options.GapLine(12f);
		options.Label("TwitchToolkitNeutralViewers".Translate(), -1f, null);
		options.SliderLabeled("TwitchToolkitGoodKarma".Translate(),  ref TierTwoGoodBonus, Math.Round((double)TierTwoGoodBonus).ToString(), 1f);
		options.SliderLabeled("TwitchToolkitNeutralKarma".Translate(),  ref TierTwoNeutralBonus, Math.Round((double)TierTwoNeutralBonus).ToString(), 1f);
		options.SliderLabeled("TwitchToolkitBadKarma".Translate(),  ref TierTwoBadBonus, Math.Round((double)TierTwoBadBonus).ToString(), 1f);
		options.Gap(12f);
		options.GapLine(12f);
		options.Label("TwitchToolkitBadViewers".Translate(), -1f, null);
		options.SliderLabeled("TwitchToolkitGoodKarma".Translate(),  ref TierThreeGoodBonus, Math.Round((double)TierThreeGoodBonus).ToString(), 1f);
		options.SliderLabeled("TwitchToolkitNeutralKarma".Translate(),  ref TierThreeNeutralBonus, Math.Round((double)TierThreeNeutralBonus).ToString(), 1f);
		options.SliderLabeled("TwitchToolkitBadKarma".Translate(),  ref TierThreeBadBonus, Math.Round((double)TierThreeBadBonus).ToString(), 1f);
		options.Gap(12f);
		options.GapLine(12f);
		options.Label("TwitchToolkitDoomViewers".Translate(), -1f, null);
		options.SliderLabeled("TwitchToolkitGoodKarma".Translate(),  ref TierFourGoodBonus, Math.Round((double)TierFourGoodBonus).ToString(), 1f);
		options.SliderLabeled("TwitchToolkitNeutralKarma".Translate(),  ref TierFourNeutralBonus, Math.Round((double)TierFourNeutralBonus).ToString(), 1f);
		options.SliderLabeled("TwitchToolkitBadKarma".Translate(),  ref TierFourBadBonus, Math.Round((double)TierFourBadBonus).ToString(), 1f);
		options.GapLine(12f);
		options.Gap(12f);
		Text.Font =((GameFont)2);
		...
		options.AddLabeledTextField("TwitchToolkitCustomPricingLink".Translate(),  ref CustomPricingSheetLink);
		options.Gap(12f);
		options.GapLine(12f);
		if (options.ButtonTextLabeled("Items Edit", "Open"))
		{
			...
			Window window4 = new StoreItemsWindow();
		...
		if (options.ButtonTextLabeled("Events Edit", "Open"))
		{
			...
			Window window3 = new StoreIncidentsWindow();
			Find.WindowStack.Add(window3);
		}
		options.Gap(12f);
		options.GapLine(12f);
		options.CheckboxLabeled("TwitchToolkitPurchaseConfirmations".Translate(), ref PurchaseConfirmations, null);
		options.CheckboxLabeled("TwitchToolkitRepeatViewerNames".Translate(), ref RepeatViewerNames, null);
		options.CheckboxLabeled("TwitchToolkitMinifiableBuildings".Translate(),ref  MinifiableBuildings, null);
		options.GapLine(12f);
		options.Gap(12f);
		Text.Font =((GameFont)2);
		...
		options.CheckboxLabeled("TwitchToolkitVotingChatMsgs".Translate(), ref VotingChatMsgs, null);
		options.CheckboxLabeled("TwitchToolkitVotingWindow".Translate(), ref VotingWindow, null);
		options.CheckboxLabeled("TwitchToolkitLargeVotingWindow".Translate(), ref LargeVotingWindow, null);
		options.Gap(12f);
		if (options.ButtonTextLabeled("Edit Storyteller Packs", "Storyteller Packs"))
		{
			...
			Find.WindowStack.TryRemove(window2.GetType(), true);
		...
		options.CheckboxLabeled("TwitchToolkitViewerColonistQueue".Translate(), ref ViewerNamedColonistQueue, null);
		options.CheckboxLabeled("Charge viewers to join queue?", ref ChargeViewersForQueue, null);
		...
		options.Gap(12f);
		options.GapLine(12f);
		if (options.ButtonText("Edit Viewers", null))
		{
